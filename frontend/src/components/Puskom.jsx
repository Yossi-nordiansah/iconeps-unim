...
const Puskom = () => {
    return (
     <div className='flex sm:flex-row flex-col-reverse shadow-2xl overflow-hidden bg-white rounded-tr-[50px] rounded-br-[50px]'>
       <div className='sm:w-1/2'>
         ...
         <div className='px-5 mt-3 sm:mt-10'>
           ...
           <button className='px-5 py-2 mb-8 text-white rounded-full sm:mb-10 bg-blue-950 font-montserrat_bold'>
             Daftar Sekarang
           </button>
         </div>
       </div>
       <div className='sm:h-auto h-72 sm:w-1/2' style={{ backgroundImage: `url(${puskom})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: "no-repeat" }}>
