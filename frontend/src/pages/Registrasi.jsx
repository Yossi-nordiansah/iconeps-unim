...
const Registrasi = () => {
  ...
  const handleOnSubmitRegister = async (e) => {
    ...
    // Cegah pengiriman jika sudah dalam proses submit
  ...
  return (
    <div className='min-h-screen bg-gradient-to-b shadow-2xl from-blue-800 to-teal-300 flex justify-center items-center'>
      <form
        ...
        className='min-w-64 h-fit max-w-[450px] rounded-lg text-gray-950 backdrop-blur bg-white/20 py-4 px-4'
      >
        <h1 className='font-semibold text-center mb-2 text-xl'>Registrasi</h1>
        {/* Input fields */}
        {/* Password fields */}
        <button
          className='bg-gradient-to-r from-blue-600 to-blue-900 w-full py-2 rounded font-semibold text-white'
          type='submit'
